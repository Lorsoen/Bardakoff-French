...
void onInit()
{
    ...
    CONTROL_STICK_INSTRUCTIONS = "SÉLECTIONNER UN FICHIER À L'AIDE DU STICK.";
    ERASE_INSTRUCTIONS = "APPUYEZ SUR A POUR JOUER OU SUR Z POUR EFFACER!";
    ERASE_CONFIRMATION = "ÊTES-VOUS SÛR? APPUYEZ SUR A POUR CONFIRMER OU SUR B POUR ANNULER.";

    D_8036C4E0[0].str = "CONTINUER";
    D_8036C4E0[1].str = "QUITTER LE MONDE";
    D_8036C4E0[2].str = "STATISTIQUES";
    D_8036C4E0[3].str = "SAUVER ET QUITTER";

    D_8036C58C[0].string = (u8 *)"SCORE TOTAL";
}
...
void overwriteString()
{
    ...
    *(const char **)ptr = D_80383010.unk3_6 ? "ÊTES-VOUS SÛR?" : "A - OUI, B - NON";
